  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <div style={{
        ...
        border: `2px solid ${captured ? 'var(--primary)' : 'var(--border)'}`,
        ...
        <div style={{
          ...
          color: captured ? 'var(--primary)' : 'var(--grey)',
        }}>
      ...
      {!captured ? (
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button className="btn btn-outline" onClick={() => setCaptured(null)} disabled={loading}>Retake</button>
